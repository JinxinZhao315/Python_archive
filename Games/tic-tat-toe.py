...
def drawMove (board, boardRow, boardCol, Piece):
    ...
    centerX = ((boardCol) * 100) +15
    centerY = ((boardRow) * 100) +15
    cross = pygame.image.load("/Users/vj/Documents/Coding/Python/Practices/Games/cross.png")
    circle = pygame.image.load("/Users/vj/Documents/Coding/Python/Practices/Games/circle.png")


    # draw the appropriate piece
    if (Piece == 'O'):
        board.blit(circle,(centerX,centerY))
    else:
        board.blit(cross,(centerX,centerY))
